    ...
    <div className="flex flex-col min-h-screen bg-surface">
      ...
      <section className="relative overflow-hidden py-24 sm:py-32">
        <div className="absolute inset-0 -z-20">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-cyan-100/70 via-surface/85 to-surface dark:from-cyan-900/30 dark:via-[#050505]/80 dark:to-[#050505]" />
        </div>
        ...
        >
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-1.5 rounded-full border border-cyan-500/50 bg-cyan-500/10 px-4 py-1.5 text-xs font-black text-cyan-600 dark:text-cyan-400 mb-6 uppercase tracking-widest">
            Our Mission
          </motion.div>
          <motion.h1 variants={fadeInUp} className="text-4xl font-extrabold tracking-tight text-ink sm:text-5xl md:text-6xl mb-6">
            Engineering the <span className="text-cyan-600 dark:text-cyan-400">Future</span> of Commerce.
          </motion.h1>
          <motion.p variants={fadeInUp} className="text-lg text-ink-2 leading-relaxed max-w-2xl mx-auto">
      ...
      <section className="py-20 border-t border-line bg-surface-4">
            ...
            <motion.div variants={fadeInUp} className="space-y-6">
              ...
              <div className="pt-4 flex gap-4">
                <div className="flex flex-col border-l-2 border-cyan-500 pl-4">
                  <span className="text-3xl font-black text-ink">10K+</span>
                  <span className="text-xs font-bold text-ink-3 uppercase tracking-widest">Happy Clients</span>
                </div>
                <div className="flex flex-col border-l-2 border-pink-500 pl-4">
                  <span className="text-3xl font-black text-ink">100%</span>
                  <span className="text-xs font-bold text-ink-3 uppercase tracking-widest">Verified Gear</span>
                </div>
              </div>
            </motion.div>
      ...
      {/* Core values */}
      <section className="py-24 bg-surface border-t border-line relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-cyan-200/50 dark:bg-cyan-900/20 rounded-full blur-[120px] pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-pink-200/50 dark:bg-pink-900/20 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <motion.h2 variants={fadeInUp} className="text-3xl font-extrabold text-ink sm:text-4xl">Our Core Values</motion.h2>
            <motion.p variants={fadeInUp} className="mt-4 text-ink-2">The principles that drive every decision we make.</motion.p>
          </motion.div>
          ...
          >
            <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-surface-2 border border-cyan-500/30 p-10 rounded-[2rem] hover:shadow-[0_0_20px_rgba(0,243,255,0.15)] transition-all relative overflow-hidden group">
              ...
              <h3 className="text-xl font-bold text-ink mb-4">Uncompromised Quality</h3>
            ...
            <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-surface-2 border border-pink-500/30 p-10 rounded-[2rem] hover:shadow-[0_0_20px_rgba(255,0,255,0.15)] transition-all relative overflow-hidden group">
              ...
              <h3 className="text-xl font-bold text-ink mb-4">Community First</h3>
              <p className="text-sm text-ink-2 leading-relaxed">
            ...
            <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-surface-2 border border-purple-500/30 p-10 rounded-[2rem] hover:shadow-[0_0_20px_rgba(176,38,255,0.15)] transition-all relative overflow-hidden group">
              ...
              <h3 className="text-xl font-bold text-ink mb-4">Open Transparency</h3>
              <p className="text-sm text-ink-2 leading-relaxed">
